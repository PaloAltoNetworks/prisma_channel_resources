...
Keep in mind, deploying things has it's disadvantages, primarily from the learning angle.  

## Assumptions

You understand that this is not a production ready deployment of Prisma Cloud Compute or any other tool in the lab. This is meant to be a local deployment on a virtualization platform like VirtualBox or VMWare Fustion/Workstation. 
