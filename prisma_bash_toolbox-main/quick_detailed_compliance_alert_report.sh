...
REPORT_LOCATION="./reports/$REPORT_DATE-$COMPLIANCE_STD_NAME-detailed-compliance-report.csv"
...
printf '\n%s\n\n' "All done! Your report is saved in the ./reports directory as $REPORT_DATE-$COMPLIANCE_STD_NAME-detailed-compliance-report.csv"
