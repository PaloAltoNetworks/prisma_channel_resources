...
printf '%s\n' "policyName, policyDescription, policySeverity, policyType, policyRecommendation, account, resourceName, resourceType, resourceArn, standardName, requirementName, sectionId, sectionDescription"> "./$REPORT_DATE-$COMPLIANCE_STD_NAME-detailed-compliance-report.csv"
